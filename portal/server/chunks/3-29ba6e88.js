const index = 3;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-7315b5bb.js')).default;
...
const stylesheets = ["_app/immutable/assets/Button.bd53f61f.css"];
const fonts = [];

export { component, fonts, imports, index, stylesheets };
//# sourceMappingURL=3-29ba6e88.js.map
